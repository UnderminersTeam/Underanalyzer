...
internal class MacroTypeRegistryConverter : JsonConverter<MacroTypeRegistry>
{
    public MacroTypeRegistry Registry { get; }

    public MacroTypeRegistryConverter(MacroTypeRegistry existing)
    {
        Registry = existing;
    }

    public override MacroTypeRegistry Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
    ...
    public override void Write(Utf8JsonWriter writer, MacroTypeRegistry value, JsonSerializerOptions options)
    {
