...
public sealed class CompileContext(string code, CompileScriptKind scriptKind, string? globalScriptName, IGameContext gameContext)
{
    ...
    /// <summary>
    /// Set of local variables declared in any function scope generated by this compile context.
    /// </summary>
    /// <remarks>
    /// Only not null during parsing and parse post-processing.
    /// </remarks>
    internal HashSet<string>? DeclaredLocals = null;

    /// <summary>
    /// List (in order) of local variables declared in any function scope generated by this compile context.
    /// </summary>
    /// <remarks>
    /// Only not null after the start of parsing.
    /// </remarks>
    internal List<string>? LocalsOrder = null;
    ...
    public void Compile()
    {
        ...
        // Create structures for tracking locals
        DeclaredLocals = new(8);
        LocalsOrder = new(8);
